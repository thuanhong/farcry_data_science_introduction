...
![Far Cry Wallpaper](image/farcry_wallpaper_introduction.jpg)
...
![Multiplayer Match Session Leaderboard](image/farcry_multiplayer-match-session-leaderboard.jpg)
...
| Name                                              | Code                                                  | Photo                                                    |
| ------------------------------------------------- | ----------------------------------------------------- | -------------------------------------------------------- |
| Machete                                           | `Machete`                                             | ![](image/farcry_weapon_machete.png)                     |
| Jungle Falcon                                     | `Falcon`                                              | ![](image/farcry_weapon_jungle-falcon.png)               |
| Jackhammer Shotgun                                | `Shotgun`                                             | ![](image/farcry_weapon_jackhammer-shotgun.png)          |
| P90 SMG                                           | `P90`                                                 | ![](image/farcry_weapon_p90-smg.png)                     |
| MP5 SMG                                           | `MP5`                                                 | ![](image/farcry_weapon_mp5-smg.png)                     |
| M4 Carbine                                        | `M4`                                                  | ![](image/farcry_weapon_m4-carbine.png)                  |
| AG36 Assault Rifle                                | `AG36` for the rifle, `AG36Grenade` for the explosive | ![](image/farcry_weapon_ag36-assault-rifle.png)          |
| OICW Advanced Assault Rifle                       | `OICW` for the rifle, `OICWGrenade` for the explosive | ![](image/farcry_weapon_oicw-advanced-assault-rifle.png) |
| AW50 Sniper Rifle                                 | `SniperRifle`                                         | ![](image/farcry_weapon_aw50-sniper-rifle.png)           |
| M249 SAW MG                                       | `M249`                                                | ![](image/farcry_weapon_m249-saw-mg.png)                 |
| Rocket Launcher                                   | `Rocket`                                              | ![](image/farcry_weapon_rocket-launcher.png)             |
| Grenade                                           | `HandGrenade`                                         | ![](image/farcry_weapon_grenade-mk2.jpg)                 |
| Mk.19 Mounted Mortar Launcher Platform            | `StickyExplosive`                                     | ![](image/farcry_weapon_mortar.jpg)                      |
| Patrol Boat (when a player runs over another)     | `Boat`                                                | ![](image/farcry_vehicle_patrol-boat.jpg)                |
| Humvee or Buggy (when a player runs over another) | `Vehicle`                                             | ![](image/farcry_vehicle_buggy.png)                      |
| Rocket Launcher mounted on a vehicle              | `VehicleMountedRocketMG`                              | ![](image/farcry_vehicle_humvee.png)                     |
| Mounted Minigun                                   | `VehicleMountedAutoMG`, `MG`                          | ![](image/farcry_weapon_vulcan-minigun.jpg)              |
| Machine Gun mounted on a vehicle                  | `VehicleMountedMG`                                    | ![](image/farcry_vehicle_buggy.png)                      |
| Rocket Launcher mounted on a vehicle              | `VehicleRocket`                                       | ![](image/farcry_vehicle_humvee.png)                     |
...
| ----------------------------------------- | ---------------------------------------------- |
| ![](image/farcry_game_session_launch.png) | ![](image/farcry_game_session_map_loading.png) |
...
![Far Cry Frag History Spreadsheet](image/farcry_frag-history_spreadsheet.png)
...
![Google Sheets Distinct Players](image/farcry_google_sheets_distinct_players.jpg)
...
![Google Sheets Row Expansion Issue](image/farcry_google_sheets_array_issue.png)
...
![Far Cry Match Statistics](image/farcry_google_sheets_match_statistics.png)
...
![CSV File Import](image/farcry_google_sheets_import_csv_file.png)
...
![Far Cry Match Statistics Sheet](image/farcry_google_sheets_match_statistics_sheet_01.png)
...
| --------------------------------------------------------- | ------------------------------------------------------------- |
| ![](image/farcry_google_sheets_frag_history_sheet_02.png) | ![](image/farcry_google_sheets_match_statistics_sheet_02.png) |
...
![Far Cry Match Overall Statistics](image/farcry_google_sheets_match_statistics_sheet_03.png)

---

![](image/farcry_wallpaper_02.jpg)
...
![Far Cry Entity Diagram Design](image/farcry_erd_initial.png)
...
| ----------------------------------------------------------- | ----------------------------------------------------------------- |
| ![](image/farcry_erd_entity_match_frag_edition_initial.png) | ![](image/farcry_erd_entity_match_statistics_edition_initial.png) |
...
![Match Entity Edition](image/farcry_erd_entity_match.png)
...
![Entity Match Design](image/farcry_erd_entity_match_edition.png)
...
![Entity Match Frag Final Design](image/farcry_erd_entity_match_frag_edition_final.png)
...
| --------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| ![Entities Relationship Edition](image/farcry_erd_entities_match_and_match_frag_relationship_edition.png) | ![Entities Relationship Diagram](image/farcry_erd_entities_match_and_match_frag_relationship.png) |
...
![Entity Cardinality Edition](image/farcry_erd_entities_match_and_match_frag_cardinality_edition.png)
...
![Entity Relationship Diagram Final](image/farcry_erd_final.png)
...
![SQLite Table Match](image/farcry_sqlite_table_match_edition.png)
...
![Far Cry SQLite Database Structure](image/farcry_sqlite_database_structure_initial.png)
...
![Table Match Frag Foreign Key Edition](image/farcry_sqlite_table_match_frag_foreign_key_edition.png)
...
![Table Match Data Browsing](image/farcry_sqllite_table_match_data_browsing.png)
...
![Tabe Match Frag Data Browsing](image/farcry_sqllite_table_match_frag_data_browsing.png)

---

![](image/farcry_wallpaper_04.jpg)
...
![SQLite CLI](image/farcry_sqlite_cli_introduction.png)
...
![Versatile Killer](image/farcry_statistics_versatile_killer.jpg)
...
|                                                       | Class      | Weapons                                                                                                                                                                                 |
| ----------------------------------------------------- | ---------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| ![Hitman](image/farcry_class_hitman.png)              | Hitman     | `Machete`, `Falcon`, `MP5`                                                                                                                                                              |
| ![Sniper](image/farcry_class_sniper.png)              | Sniper     | `SniperRifle`                                                                                                                                                                          |
| ![Commando](image/farcry_class_commando.jpg)          | Commando   | `AG36`, `OICW`, `P90`, `M4`, `Shotgun`, `M249`                                                                                                                                          |
| ![Psychotic Killer](image/farcry_class_psychotic.jpg) | Psychopath | `Rocket`, `VehicleRocket`, `HandGrenade`, `StickExplosive`, `Boat`, `Vehicle`, `VehicleMountedRocketMG`, `VehicleMountedAutoMG`, `MG`, `VehicleMountedMG`, `OICWGrenade`, `AG36Grenade` |
...
![Serial Killer](image/farcry_statistics_serial_killer.jpg)
...
![Serial Loser](image/farcry_statistics_serial_loser.png)
...
![Lucky Luke Killer](image/farcry_statistics_lucky_luke_killer.jpg)
